    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mt-12 space-y-4">
            ...
            <div className="space-y-5">
              <div className="flex gap-4">
                <ShieldCheck size={22} className="mt-1 shrink-0 text-cyan-400" />
                <div>
              ...
              <div className="flex gap-4">
                <Target size={22} className="mt-1 shrink-0 text-cyan-400" />
                <div>
                  <p className="font-medium text-white">
                    Accuracy over speed
                  </p>
              ...
              <div className="flex gap-4">
                <Calculator size={22} className="mt-1 shrink-0 text-cyan-400" />
                <div>
                  <p className="font-medium text-white">
                    Free, with no signup
                  </p>
          ...
          <div className="mt-14 rounded-[1.75rem] border border-cyan-400/20 bg-cyan-400/5 p-6 sm:p-8">
            ...
            <Link
              to="/contact"
              className="mt-5 inline-flex items-center rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-blue-500"
            >
              Contact us
            </Link>
          </div>
